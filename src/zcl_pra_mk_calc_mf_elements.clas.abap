CLASS zcl_pra_mk_calc_mf_elements DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_PRA_MK_CALC_MF_ELEMENTS IMPLEMENTATION.
      ...
      CASE req_calc_elements->*.
        ...
        WHEN 'STATUSCRITICALITY'.
          ...
          LOOP AT events REFERENCE INTO event.
            event->StatusCriticality = zcl_pra_mk_calc_mf_elements=>calculate_event_status_ind( event->status ).
          ENDLOOP.
