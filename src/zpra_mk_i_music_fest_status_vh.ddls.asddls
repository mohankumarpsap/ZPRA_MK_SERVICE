...
define view entity ZPRA_MK_I_MUSIC_FEST_STATUS_VH
  as select from DDCDS_CUSTOMER_DOMAIN_VALUE( p_domain_name : 'ZPRA_MK_MUSIC_FEST_STATUS_CODE' ) as Value
                                                               ...
                                                               and _text.language       = $session.system_language
{
  ...
  key Value.value_position                                          as ValuePosition,
      ...
      _text( p_domain_name : 'ZPRA_MK_MUSIC_FEST_STATUS_CODE' ).text as Description
}
