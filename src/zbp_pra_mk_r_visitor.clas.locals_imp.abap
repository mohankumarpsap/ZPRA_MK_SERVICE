CLASS LHC_ZPRA_Mk_R_VISITOR DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
*    METHODS:
...
CLASS LHC_ZPRA_Mk_R_VISITOR IMPLEMENTATION.
...
*  ENDMETHOD.
  ...
  METHOD get_instance_authorizations.
    ...
    READ ENTITIES OF ZPRA_Mk_R_Visitor  IN LOCAL MODE
    ENTITY Visitor
