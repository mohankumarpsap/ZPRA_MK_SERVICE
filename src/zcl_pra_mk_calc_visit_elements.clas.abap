CLASS zcl_pra_mk_calc_visit_elements DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_PRA_MK_CALC_VISIT_ELEMENTS IMPLEMENTATION.
      ...
      CASE req_calc_elements->*.
        ...
        WHEN 'STATUSCRITICALITY'.
          ...
          LOOP AT visits REFERENCE INTO DATA(visit).
            visit->StatusCriticality = zcl_pra_mk_calc_visit_elements=>calculate_status_criticality( visit->status ).
          ENDLOOP.
