...
define root view entity ZPRA_MK_R_MUSICFESTIVAL
  as select from zpra_mk_a_mf as MusicFestival
  composition [0..*] of ZPRA_MK_R_VISIT                   as _Visits
  association [1..1] to ZPRA_MK_I_MUSIC_FEST_STATUS_VH as _Status on $projection.Status = _Status.Value
{
  key uuid                  as Uuid,
      title                 as Title,
